...
import { useGetPostsQuery, selectPostById, updatePost, deletePost, useUpdatePostMutation, useDeletePostMutation  } from './postsSlice'
...
const onDeletePostClicked = async () => { 
        try{
            await deletePost({id: post.id}).wrap()
            setTitle('')
            setContent('')
            setUserId('')
            navigate('/')
